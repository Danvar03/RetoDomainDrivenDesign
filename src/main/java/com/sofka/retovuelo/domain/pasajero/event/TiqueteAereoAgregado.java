...
public class TiqueteAereoAgregado extends DomainEvent {
    ...
    public TiqueteAereoAgregado(TiqueteId tiqueteId, Origen origen, Asiento asiento, Destino destino, Estado estado) {
